...
TARGET_DIR="/Users/gegham/www/rn-test/my-app/node_modules/@multiplayer-app/session-recorder-react-native"
...
echo "🛠️  Syncing package.json..."
cp -f "./package.json" "$TARGET_DIR/package.json"
cp -f "./SessionRecorderNative.podspec" "$TARGET_DIR/SessionRecorderNative.podspec"
