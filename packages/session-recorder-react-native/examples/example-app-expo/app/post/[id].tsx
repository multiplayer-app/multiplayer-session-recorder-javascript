      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <ThemedView style={styles.postCard}>
          ...
          <View style={styles.postContent}>
            ...
            {isEditMode ? (
              <TextInput
                style={[styles.textInput, styles.bodyInput, { color: Colors[colorScheme ?? 'light'].text }]}
          ...
          {isEditMode ? (
            <View style={styles.editButtons}>
              <TouchableOpacity style={[styles.actionButton, styles.cancelButton]} onPress={handleEditToggle} disabled={updating}>
            ...
            <TouchableOpacity style={[styles.actionButton, styles.deleteButton]} onPress={deletePost} disabled={deleting}>
              {deleting ? (
                <ActivityIndicator size='small' color='white' />
              ) : (
